...
My research develops and tests physically motivated extensions of the dark sector and connects them to observable signatures in cosmology. A defining aspect of my profile is bridging **theory and data analysis**: translating covariant model building (background + perturbations, stability, degeneracies) into survey-ready predictions, implemented in Einstein–Boltzmann solvers and confronted with multi-probe data.

## Current themes

**Interacting / extended dark sector**
- Covariant coupled dark-energy models (conformal, disformal, kinetic interactions) and their signatures in distances, clustering and lensing.
